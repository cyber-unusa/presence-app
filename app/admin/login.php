                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST">
                                        ...
                                        <div class="form-group mb-4">
                                            <input type="text" class="form-control form-control-user <?= $userErr != '' ?  'border-danger' : '' ?> " id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username" name="username" value="<?= $_SESSION["user_input"] ?>" autocomplete="off">
                                            <?php
                                            if ($userErr != '') {
